...
public class GerenciaFuncionarios {
    private static final String FILE_PATH = "C:\\Users\\paulo\\OneDrive\\Documentos\\ArquivoJava\\arquivocsv\\exercicio19\\funcionarios.dat";

    public static void main(String[] args) throws IOException {
        RandomAccessFile file = new RandomAccessFile(FILE_PATH, "rw");

        Funcionario funcionario = new Funcionario(1, "Paulo", 5000.0);
